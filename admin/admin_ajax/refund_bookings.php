    ...
    {  
        ...
        while($data = mysqli_fetch_assoc($res)) {
            ...
            $table_data .= "
                ...
                <td>
                    <b style='color: var(--admin-gold); font-size: 1.2rem;'>₹$data[total_pay]</b>
                
                </td>
                <td>
                <button type='button' onclick='refund_booking($data[booking_id])' class='btn btn-success btn-sm fw-bold shadow-none' style='padding: 10px 20px; border-radius: 6px;'>
