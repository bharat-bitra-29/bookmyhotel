            ...
            echo <<< data
                <div class="col-md-2 mb-3">
                    <div class="card text-white" style="background: linear-gradient(135deg, var(--admin-primary) 0%, var(--admin-primary-dark) 100%); border-radius: 12px; overflow: hidden; box-shadow: 0 8px 20px rgba(0,0,0,0.15);">
                        <img src="$path$row[img]" class="card-img" style="opacity: 0.9;">
                        <div class="card-img-overlay d-flex align-items-end">
                            <button type="button" onclick="del_carousel_img($row[sl_no])" class="btn btn-danger btn-sm shadow-none w-100" style="border-radius: 6px; font-weight: 600;">
