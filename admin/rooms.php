...
<head>
    ...
    <title>Rooms Management - Luxury Hotel</title>
...
<div class="container-fluid" id="main-content">
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            <h3 class="mb-4"><i class="bi bi-door-open me-2"></i>ROOMS MANAGEMENT</h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-sbold">Area (sq ft)</label>
                                ...
                                while($opt = mysqli_fetch_assoc($res)){
                                    ...
                                    <div class='col-md-3 mb-2'>
                                        <label class='d-flex align-items-center'>
                                            <input type='checkbox' name='features' value='$opt[id]' class='form-check-input shadow-none me-2'>
                                            $opt[name]
                                        </label>
                                    </div>";
                                }
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="row">
                                ...
                                while($opt = mysqli_fetch_assoc($res)){
                                    ...
                                    <div class='col-md-3 mb-2'>
                                        <label class='d-flex align-items-center'>
                                            <input type='checkbox' name='facilities' value='$opt[id]' class='form-check-input shadow-none me-2'>
                                            $opt[name]
                                        </label>
                                    </div>";
                                }
...
<div class="modal fade" id="room-images" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-images me-2"></i>Room Images</h5>
            ...
            <div class="modal-body">
                ...
                <div class="border-bottom border-3 pb-3 mb-3">
                    <form id="add_image_form">
                        ...
                        <button type="submit" class="btn custom-bg text-white shadow-none"><i class="bi bi-upload me-2"></i>Add</button>
                        <input type="hidden" name="room_id">
                    </form>
                </div>
