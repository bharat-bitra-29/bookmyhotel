...
define('SITE_URL', $protocol . "://" . $host . "/bookmyhotel/");
...
//sendgrid API KEY
define('BREVO_SMTP_KEY', $env['BREVO_SMTP_KEY']);
define('BREVO_EMAIL',"bookmyhotel.info@gmail.com");
define('MAIL_FROM_NAME',"bookmyhotel");
